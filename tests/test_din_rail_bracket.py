# tests/test_din_rail_bracket.py
"""Tests for din_rail_bracket generator."""
from pipeline.categories.din_rail_bracket import DinRailBracketGenerator


def test_din_rail_bracket_generates_valid_solid():
    gen = DinRailBracketGenerator()
    assert gen.category == "din_rail_bracket"
