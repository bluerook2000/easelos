# tests/test_bearing_block.py
"""Tests for bearing_block generator."""
from pipeline.categories.bearing_block import BearingBlockGenerator


def test_bearing_block_generates_valid_solid():
    gen = BearingBlockGenerator()
    assert gen.category == "bearing_block"
